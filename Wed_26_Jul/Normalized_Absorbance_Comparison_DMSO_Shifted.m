function main()
    ...
    figure
    hold on
    plot(wavelengths_new, absorbances_new_normalized, 'DisplayName', '25 Jul (After Lunch)');
    plot(wavelengths_old, absorbances_old_normalized, 'DisplayName', '25 Jul (Before Lunch)');
    plot(wavelengths_dmso_shifted, absorbances_dmso_normalized, 'DisplayName', '26 Jul (Morning)');

    % Set the labels and title
    xlabel('Wavelength (nm)')
    ylabel('Normalized Absorbance')
    title('Comparison of Normalized Absorbance Spectra with Shifted Spectrum')
