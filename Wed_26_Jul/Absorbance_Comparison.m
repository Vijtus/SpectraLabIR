function main()
    ...
    data1 = load_data('Ru(bpy)3inDMSOsolution_2507_1719.txt');
    data2 = load_data('Ru(bpy)3inDMSOsolution_2507_1752.txt');
    data3 = load_data('Ru(bpy)3inDMSOsolution_2607_0910.txt');
    ...
    legend('25 Jul (After Lunch)', '26 Jul (Morning)', '25 Jul (Before Lunch)')
    grid on
